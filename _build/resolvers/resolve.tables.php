...
if ($object->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('statusmessage_core_path', null, $modx->getOption('core_path') . 'components/statusmessage/') . 'model/';
            $modx->addPackage('statusmessage', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/statusmessage/model/schema/statusmessage.mysql.schema.xml';
